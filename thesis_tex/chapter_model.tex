...
In particular cases this lead to "lumps" of similar images concentrated in small region of the projection space.
It appeared, that differences between the images within the lump and a rather similar reconstruction effected the training error only slightly comparing to more contrastive sequences.
Which resulted in low gradient values comparable to noisy effect of more contrastive data. 
