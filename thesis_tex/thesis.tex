...
\documentclass[12pt,master,english,openright]{hgbthesis}
...
\usepackage[top=4cm,left=3cm,right=3cm,bottom=4cm]{geometry}
...
\cleardoublepage
\include{chapter_technical_details}
\cleardoublepage
\include{chapter_model}
\cleardoublepage
