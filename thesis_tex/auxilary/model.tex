...
%   \draw (0,-1) -- (4,-1);
\end{tikzpicture}
\caption{Spatial feature extractor with regularization terms. Loss-term $L_{x*}$ represents reconstruction loss, which is typically based on mean-squared error but might vary depending on the underlying autoencoder architecture.}
\label{fig:model}
\end{figure}
