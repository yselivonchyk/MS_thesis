...
\subsection{Meaningfull feature selection}\label{ch:sae}
...
One of the first application of autoencoders in deep learning was using them as base for classification
